...
bagData_pose   = readtable("15_pose.csv");
bagData_wrench = readtable("15_wrench.csv");
...
i_cp = 1695;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 1339;    % # of the F/T sensor rosbag time-stamp at which the collision happens
