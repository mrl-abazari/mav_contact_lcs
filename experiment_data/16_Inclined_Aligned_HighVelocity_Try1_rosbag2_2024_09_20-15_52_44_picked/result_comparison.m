...
bagData_pose   = readtable("16_pose.csv");
bagData_wrench = readtable("16_wrench.csv");
...
i_cp = 1261;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 906;    % # of the F/T sensor rosbag time-stamp at which the collision happens
