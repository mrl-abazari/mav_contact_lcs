...
bagData_pose   = readtable("05_pose.csv");
bagData_wrench = readtable("05_wrench.csv");
...
i_cp = 1783;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 1413;    % # of the F/T sensor rosbag time-stamp at which the collision happens
