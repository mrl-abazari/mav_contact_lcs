...
bagData_pose   = readtable("12_pose.csv");
bagData_wrench = readtable("12_wrench.csv");
...
i_cp = 855;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 670;   % # of the F/T sensor rosbag time-stamp at which the collision happens
