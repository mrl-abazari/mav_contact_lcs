...
bagData_pose   = readtable("02_pose.csv");
bagData_wrench = readtable("02_wrench.csv");
...
i_cp = 1272;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 1191;    % # of the F/T sensor rosbag time-stamp at which the collision happens
...
legend('Experiment (raw)', 'Experiment (filtered)', 'Simulation', 'FontSize', 20)
grid on
f1.Units = "inches";
