...
bagData_pose   = readtable("21_pose.csv");
bagData_wrench = readtable("21_wrench.csv");
...
i_cp = 949;   % # of the position   rosbag time-stamp at which the collision happens
i_cw = 890;    % # of the F/T sensor rosbag time-stamp at which the collision happens
